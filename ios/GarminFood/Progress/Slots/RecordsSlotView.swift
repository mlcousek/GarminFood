...
//
// STUB (add-gamification-signals D12): the Progress-tab slot for the personal records.
// Ships empty; `add-journeys-and-records` replaces this file's contents (and adds its
