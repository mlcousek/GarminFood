...
public actor WeightStore {
    ...
    private func loadIfNeeded() {
        ...
        let result = FoodLogCoreStorage.loadPersistedJSON([WeightEntry].self, from: fileURL, decoder: decoder, category: "WeightStore")
    ...
    private func persist() throws {
        try FoodLogCoreStorage.ensureSafeToWrite(loaded: loaded, fileURL: fileURL, category: "WeightStore")
