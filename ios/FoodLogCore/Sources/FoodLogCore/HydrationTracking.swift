...
public actor HydrationStore {
    ...
    private func loadIfNeeded() {
        ...
        let result = FoodLogCoreStorage.loadPersistedJSON([HydrationEntry].self, from: fileURL, decoder: decoder, category: "HydrationStore")
    ...
    private func persist() throws {
        try FoodLogCoreStorage.ensureSafeToWrite(loaded: loaded, fileURL: fileURL, category: "HydrationStore")
